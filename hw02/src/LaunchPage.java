    ...
    LaunchPage() {
        ...
        btn.addActionListener(new ActionListener() { //Suggestion Button
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (t1.getText().equals("GTA Five") && e.getSource() == btn) {
                    NewWindow myWindow = new NewWindow(); Animate myWindow3 = new Animate();
                    myWindow3.init();
                } else if (t2.getText().equals("Photoshop")&&e.getSource()==btn) {
                    NewWindow2 myWindow2 = new NewWindow2(); Animate myWindow3 = new Animate();
